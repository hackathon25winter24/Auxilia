...
func (c *battleServiceClient) FetchActionLog(ctx context.Context, in *FetchActionLogRequest, opts ...grpc.CallOption) (*GameActionLog, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GameActionLog)
	err := c.cc.Invoke(ctx, BattleService_FetchActionLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BattleService_FetchActionLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchActionLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BattleServiceServer).FetchActionLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BattleService_FetchActionLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BattleServiceServer).FetchActionLog(ctx, req.(*FetchActionLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BattleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BattleService_FetchActionLog_Handler,
		},
	},
